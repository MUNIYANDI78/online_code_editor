...
const CppLearn = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:3000/api/learn/cpp')
  ...
  return (
    <div className='min-h-screen p-6 text-white bg-black'>
      <Navbar/>
      <h1 className='text-3xl font-bold mb-6 text-center'>📘 C++ Learn</h1>
      ...
      <div className='flex justify-center gap-6 mt-12'>
        <button
          onClick={() => navigate('/challenges/cpp')}
